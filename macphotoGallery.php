		...
		<div style="float: right; width: 80%">
			...
			Select Album <select  onchange="displaySelectedAlbum(this.value,'<?php echo $pageURL[0] ; ?>')" > 
				...
				<ul class="alignright actions">
					<li><a
						href="<?php echo $site_url ?>/wp-admin/admin.php?page=macPhotos&albid=<?php echo $macAlbum->macAlbum_id; ?>"
			...
			{ ?>
				<a
					href="<?php echo $site_url?>/wp-admin/admin.php?page=macPhotos&action=viewPhotos&albid=<?php echo $albid;?>&pages=viewAll">See
					All</a>
			</div>
			<?php
			}
		...
		<div class="clear">
			<div style="width: 30%; float: left; margin-right: 15px;">
				...
				<form name="frm1">
					...
					<div class="macLeft" style="padding-left: 5px"> <a href="<?php echo $site_url.'/wp-admin/admin.php?page=macAlbum'?>">Create New Album</a></div>
				</form>
